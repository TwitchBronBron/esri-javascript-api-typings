...
// Converted from https://raw.githubusercontent.com/Esri/jsapi-resources/91d2ad688ebd4eeb0a9424f2935739bc481c27b8/3.x/typescript/arcgis-js-api.d.ts
...
declare namespace esriTypes {
  ...
  export interface GeographicTransformationOptions {
    ...
    steps?: geometry.GeographicTransformationStep[];
  }
  ...
  export interface ReportPlayerOptions {
    ...
    dataProvider?: dijit.geoenrichment.ReportPlayer.DataProviderGE;
    ...
    theme?: dijit.geoenrichment.ReportPlayer.PlayerThemes;
    /**
...
declare namespace esriTypes.arcadeProfiles {
  ...
  export var fieldCalculateProfile: {
    /**
  ...
  export var visualizationProfile: {
    /**
...
declare namespace esriTypes.dijit {
  ...
  export class ClassedColorSlider extends RendererSlider {
    ...
    on(type: "data-change", listener: (event: { breakInfos: any[]; maxValue: number; minValue: number; target: ClassedColorSlider }) => void): Handle;
  ...
  export class ClassedSizeSlider extends RendererSlider {
    ...
    /** Fires during slide and slide stop, and when a handle or the  minValue or  maxValue of the slider are updated via text box. */
    on(type: "data-change", listener: (event: { breakInfos: any[]; maxValue: number; minValue: number; target: ClassedSizeSlider }) => void): Handle;
    /** Fires when  minValue or  maxValue are updated via textbox. */
  ...
  export class ColorInfoSlider extends RendererSlider {
    ...
    on(type: "data-change", listener: (event: { colorInfo: any; maxValue: number; minValue: number; target: ColorInfoSlider }) => void): Handle;
  ...
  export interface ImageServiceMeasureConstructor {
	     ...
	     * @param srcNode Reference or id of the HTML element where the widget should be rendered.
	     */
	    new(params: ImageServiceMeasureOptions, srcNode: Node | string): ImageServiceMeasure;
  }
  ...
  export interface InfoWindowLiteConstructor {
	     ...
	     * @param srcNodeRef Reference or id of the HTML element where the widget should be rendered.
	     */
	    new(params: any, srcNodeRef: Node | string): InfoWindowLite;
  }
  ...
  export class Popup extends InfoWindowBase {
    ...
    clusterFillSymbol: symbols.FillSymbol;
  ...
  export class SizeInfoSlider extends RendererSlider {
    ...
    on(type: "data-change", listener: (event: { maxValue: number; minValue: number; sizeInfo: any; target: SizeInfoSlider }) => void): Handle;
...
declare namespace esriTypes.dijit.geoenrichment.ReportPlayer {
  ...
  export class PlayerResizeModes {
  }
  export interface PlayerResizeModesConstructor {
	  ...
	  MANUAL: any;
      new(): PlayerResizeModes
  }
  /** Enumerator of available theme options for displaying the Report Player. */
  export class PlayerThemes {
  }
  export interface PlayerThemesConstructor {
  ...
  export class PlayerViewModes {
  }
  export interface PlayerViewModesConstructor {
	    /** Displays one full page at a time. */
	  FULL_PAGES: any;
	    /** Panels will be shown in the slides view mode. */
	  PANELS_IN_SLIDES: any;
  ...
  export interface ReportPlayerConstructor {
	    /**
	     ...
	     * @param srcNode Reference or id of the HTML element where the widget should be rendered.
	     */
	    new(params?: ReportPlayerOptions, srcNode?: Node | string): ReportPlayer;
  }
}
...
declare namespace esriTypes.geometry {
  ...
  export class GeographicTransformation {
    /** Geographic transformation steps. */
  ...
  export interface GeographicTransformationConstructor {
	    /**
	     * Creates a new GeographicTransformation object.
	     * @param params See options descriptions for further information.
	     */
	    new(params?: GeographicTransformationOptions): GeographicTransformation;
  }
  ...
  export interface GeographicTransformationStepConstructor {
	    /**
	     * Creates a new GeographicTransformationStep object.
	     * @param params See the params table for additional information.
	     */
	    new(params?: GeographicTransformationStepOptions): GeographicTransformationStep;
  }
  ...
  export var coordinateFormatter: {
    /**
...
declare namespace esriTypes.layers {
  ...
  export class FeatureLayer extends GraphicsLayer {
    ...
    on(type: "refresh-tick", listener: (event: { target: FeatureLayer }) => void): Handle;
    /** Fires when a layer resumes drawing. */
  ...
  export class KMLLayer extends Layer {
    ...
    on(type: "network-link-error", listener: (event: { error: Error; target: KMLLayer }) => void): Handle;
  ...
  export interface WCSConnectionConstructor {
	    /** Resamples pixel by bilinear interpolation. */
	  INTERPOLATION_BILINEAR: any;
	    /** Resamples pixel by cubic convolution. */
	  INTERPOLATION_CUBICCONVOLUTION: any;
	  ...
	  INTERPOLATION_NEARESTNEIGHBOR: any;
	     ...
	     * @param options Optional parameters.
	     */
	    new(url: string, options?: WCSConnectionOptions): WCSConnection;
  }
  ...
  export interface WCSCoverageDescriptionConstructor {
	    /** Resamples pixel by bilinear interpolation. */
	  INTERPOLATION_BILINEAR: any;
	    /** Resamples pixel by cubic convolution. */
	  INTERPOLATION_CUBICCONVOLUTION: any;
	  ...
	  INTERPOLATION_NEARESTNEIGHBOR: any;
	     ...
	     */
	    new(coverageDocument: string, version: string): WCSCoverageDescription;
  }
  ...
  export interface WCSLayerConstructor {
	    /** Resamples pixel by bilinear interpolation. */
	  INTERPOLATION_BILINEAR: any;
	    /** Resamples pixel by cubic convolution. */
	  INTERPOLATION_CUBICCONVOLUTION: any;
	  ...
	  INTERPOLATION_NEARESTNEIGHBOR: any;
	     ...
	     * @param options Optional parameters.
	     */
	    new(url: string, options?: WCSLayerOptions): WCSLayer;
  }
  ...
  export interface WMSLayerInfoConstructor {
	     ...
	     * @param options See options list for parameters.
	     */
	    new(options?: WMSLayerInfoOptions): WMSLayerInfo;
  }
...
declare namespace esriTypes.layers.pixelfilters {
  ...
  export interface StretchFilterConstructor {
	    /**
	     * Creates an instance of a StretchFilter.
	     * @param options Optional parameters.
	     */
	    new(options?: StretchFilterOptions): StretchFilter;
  }
}
...
declare namespace esriTypes.styles {
...
declare namespace esriTypes.support {
...
declare namespace sri.dijit.geoenrichment.ReportPlayer {
  /** Enumerator of available zoom behavior options for the ReportPlayer. */
  export class PlayerZoomBehaviors {
  }
  export interface PlayerZoomBehaviorsConstructor {
